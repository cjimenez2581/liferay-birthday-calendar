...
package com.rivetlogic.birthday.calendar.service;
 ...
 * @generated
 */
public class CustomContactLocalServiceClp implements CustomContactLocalService {
	public CustomContactLocalServiceClp(
		...
		_methodName3 = "findUsersByDate";

		_methodParameterTypes3 = new String[] { "int", "int" };

		_methodName4 = "getUpcomingBirthday";

		_methodParameterTypes4 = new String[] { "java.util.Date", "long" };

		_methodName5 = "getContactsByWeek";

		_methodParameterTypes5 = new String[] {
				"int", "int", "int", "int", "int", "int"
			};

		_methodName6 = "getContactsByBirthdayMonth";

		_methodParameterTypes6 = new String[] { "int", "int", "int" };

		_methodName7 = "getGroupedMonthBirthdays";
	...
	public java.util.List<com.liferay.portal.model.Contact> findUsersByDate(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { month, day });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.liferay.portal.model.Contact> getContactsByBirthdayMonth(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName6,
					...
					new Object[] { month, startDay, endDay });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.Map<java.lang.Integer, java.lang.Integer> getGroupedMonthBirthdays(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName7,
					_methodParameterTypes7, new Object[] { year, month });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
		...
		return (java.util.Map<java.lang.Integer, java.lang.Integer>)ClpSerializer.translateOutput(returnObj);
	}
