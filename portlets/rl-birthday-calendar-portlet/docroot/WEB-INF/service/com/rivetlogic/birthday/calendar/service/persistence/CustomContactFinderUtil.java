...
package com.rivetlogic.birthday.calendar.service.persistence;
...
public class CustomContactFinderUtil {
	...
	public static CustomContactFinder getFinder() {
		if (_finder == null) {
			_finder = (CustomContactFinder)PortletBeanLocatorUtil.locate(com.rivetlogic.birthday.calendar.service.ClpSerializer.getServletContextName(),
